...
Handle::requiredParameters([$_SESSION['party-setup']], Popups::requiredField(), "party-overview.php");
...
require_once "./app/views/party-dashboard/party-edit-detail-form.php";
