...
$tickets = Tickets::boughtTickets($account->account_id);
        ...
        <div class="uk-width-1-1">
            <div class="uk-card uk-card-default uk-card-hover">
                <div class="uk-card-header">
                    <h3 class="customized-dashboard-card-title">Mijn Tickets</h3>
                </div>
                <div class="uk-card-body">
                    <?php require_once "./app/views/tickets/tickets-overview.php" ?>
                </div>
            </div>
        </div>
    </div>
